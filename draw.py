...
class Draw:
    ...
    def __init__(self, img):
        ...
        self.img = img      #Variavel para armazenar a imagem
        self.last_img = img #Variavel para armazenar a imagem uma acao antes (Para permitir desfazer acao)
    ...
    def get_key(self, event):
        ...
        if event.key == '+':
            ...
            self.img = np.array(self.last_image, copy=True)
        self.canvas_update()
    ...
    def get_position(self, event):
        ...
        self.last_image = np.array(self.img, copy=True)
...
#Leitura e Segmentacao de Imagem
